export const TR = {
  ...
  orderProcessEyebrow: "Süreç",
  orderProcessTitle: "Sipariş Sürecimiz",
  orderProcessDesc: "İlk mesajdan son yoruma kadar projenizin geçtiği aşamalar.",
  orderProcessStageOrderReceived: "Sipariş alındı",
  orderProcessStageOrderReceivedDesc: "İhtiyaçlarınız ve sipariş kapsamınız netleştirilir.",
  orderProcessStageStarted: "Siparişe başlandı",
  orderProcessStageStartedDesc: "Ödeme ve brief onayından sonra çalışmaya başlarız.",
  orderProcessStageFirstDraft: "İlk örnek teslim edildi",
  orderProcessStageFirstDraftDesc: "İlk taslak veya örnek değerlendirilmeniz için iletilir.",
  orderProcessStageRevision: "Revizyon teklif edildi",
  orderProcessStageRevisionDesc: "İlk örnek üzerinden revizyon süreci başlatılır.",
  orderProcessStageRevisionApplied: "Revize uygulandı",
  orderProcessStageRevisionAppliedDesc: "Onaylanan değişiklikler tasarıma uygulanır.",
  orderProcessStageApproved: "Sipariş onaylandı",
  orderProcessStageApprovedDesc: "Son tasarım müşteri onayından geçer ve teslim tamamlanır.",
  orderProcessStageReview: "Yorum bırakıldı",
  orderProcessStageReviewDesc: "Memnuniyetiniz ve geri bildiriminiz bizim için önemlidir.",
  status: "Durum",
  minecraft: "Minecraft",
  catDesign: "Tasarım",
...
export const EN: typeof TR = {
  ...
  orderProcessEyebrow: "Process",
  orderProcessTitle: "Our Order Process",
  orderProcessDesc: "The stages your project goes through from the first message to the final review.",
  orderProcessStageOrderReceived: "Order received",
  orderProcessStageOrderReceivedDesc: "Your needs and order scope are clarified.",
  orderProcessStageStarted: "Work started",
  orderProcessStageStartedDesc: "We start working after payment and brief approval.",
  orderProcessStageFirstDraft: "First draft delivered",
  orderProcessStageFirstDraftDesc: "The first draft or sample is sent for your review.",
  orderProcessStageRevision: "Revision offered",
  orderProcessStageRevisionDesc: "The revision process begins based on the first sample.",
  orderProcessStageRevisionApplied: "Revision applied",
  orderProcessStageRevisionAppliedDesc: "Approved changes are applied to the design.",
  orderProcessStageApproved: "Order approved",
  orderProcessStageApprovedDesc: "The final design is approved and delivery is completed.",
  orderProcessStageReview: "Review left",
  orderProcessStageReviewDesc: "Your satisfaction and feedback matter to us.",
  status: "Status",
  minecraft: "Minecraft",
  catDesign: "Design",
