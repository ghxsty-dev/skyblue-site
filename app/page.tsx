...
export default function HomePage() {
  ...
  return (
    <div>
      <section className="relative h-[calc(100vh-64px)] min-h-[500px] -mt-6 ml-[calc(-50vw+50%-24px)] mr-[calc(-50vw+50%-24px)] w-[100vw] flex items-center justify-center overflow-hidden">
        <img
          src="/background.png"
          alt=""
